...
| `jujutsu`  | *see below*   | The Jujutsu configuration.          |
...
| `format`           | `'[\\[$change_id [$all_status](yellow)\\]]($style) '` | The format for the module.                                                                   |
| `disabled`         | `false`                                               | Disables the `vcs.jujutsu` submodule.                                                        |
